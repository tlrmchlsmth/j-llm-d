#!/usr/bin/env python3
"""Collect glm sweep results and generate CSV or Google Sheet.

Reads sweep log files (one per target, e.g. glm-agg.log, glm-disagg.log)
and produces a comparison spreadsheet with Pareto frontier chart.

Usage:
    python3 glm-collect.py [-d RESULTS_DIR]
    python3 glm-collect.py [-d RESULTS_DIR] --sheets "Spreadsheet Title"
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Collect glm sweep results and generate CSV or Google Sheet"
    )
    parser.add_argument(
